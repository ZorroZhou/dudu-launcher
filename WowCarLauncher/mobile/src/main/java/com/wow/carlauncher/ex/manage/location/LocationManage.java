...
public class LocationManage extends ContextEx implements AMapLocationListener {
    private final static String TAG = "LocationManage";
...
//初始化定位
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null && aMapLocation.getErrorCode() == 0) {
            EventBus.getDefault().post(new MNewLocationEvent().setLatitude(aMapLocation.getLatitude()).setLongitude(aMapLocation.getLongitude()));
        }
    }
}
