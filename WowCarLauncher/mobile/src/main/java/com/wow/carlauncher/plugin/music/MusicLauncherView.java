...
public class MusicLauncherView extends LinearLayout implements View.OnClickListener, MusicPluginListener {
    ...
    private void init() {
        View linearLayout = inflater.inflate(R.layout.plugin_music_launcherold, null);
