...
public class NeteaseCloudMusicPluginOld extends MusicController {
    private final static String TAG = "NeteaseCloudMusicPluginOld";
    ...
    public NeteaseCloudMusicPluginOld(Context context) {
        super(context);
