package com.wow.carlauncher.plugin.music.controllers.kuwo;
...
public class KuwoMusicPopupView extends LinearLayout implements View.OnClickListener {
    private static final String TAG = "PluginMusicView";

    private LayoutInflater inflater;

    private ImageView iv_play;
    private KuwoMusicPlugin controller;
    ...
    public KuwoMusicPopupView(Context context, KuwoMusicPlugin controller) {
        super(context);
